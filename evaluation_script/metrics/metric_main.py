...
def fid50k_full(opts):   
    opts.data_1_kwargs.update(max_size=None, xflip=False)
    opts.data_2_kwargs.update(max_size=None, xflip=False)
    
    fid = frechet_inception_distance.compute_fid(opts, max_items=1000000)
...
def kid50k_full(opts):
    ...
    kid = kernel_inception_distance.compute_kid(opts, max_items=1000000, num_subsets=100, max_subset_size=1000)
...
def pr50k3_full(opts):
    ...
    precision, recall = precision_recall.compute_pr(opts, max_items=200000, nhood_size=3, row_batch_size=10000, col_batch_size=10000)
    return dict(pr50k3_full_precision=precision, pr50k3_full_recall=recall)


#----------------------------------------------------------------------------
# Legacy metrics (using). 
